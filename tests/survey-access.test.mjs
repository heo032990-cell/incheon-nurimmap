...
runInNewContext(stripTypeScriptTypes(source),{createClient:()=>db,Deno:{env:{get:()=>''},serve:fn=>handler=fn},Request,Response,AbortSignal,Intl,crypto,TextEncoder,console});
